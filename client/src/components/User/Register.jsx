...
import { registerAPI } from "../../APIServices/userAPI";
...
const Register = () => {
    ...
    const { isPending, isSuccess, isError, error } = userMutation;

    return (
        <div className="flex flex-wrap pb-4 mt-16">
            <div className="w-full  p-4">
                <div className="flex flex-col justify-center py-8 max-w-md mx-auto h-full">
                    <form onSubmit={formik.handleSubmit}>
                        <Link
                            to="/login"
                            className="inline-block text-gray-500 mb-8"
                        >
                            <span>Already have an account?</span> {""}
                            <span />
                            <span className="font-bold font-heading hover:underline">Login</span>
                        </Link>
                        ...
                        <div className="flex items-center gap-1 w-full rounded-full p-4 border border-gray-100 shadow mb-8">
                            ...
                            />
                            <span className="cursor-pointer text-xl text-gray-500" onClick={handlePassVisibility}>
