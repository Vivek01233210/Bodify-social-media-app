...
import { fetchNotificationsAPI, readNotificationAPI } from "../../APIServices/notificationAPI";
...
const NotificationList = () => {
  ...
  return (
    <div className="flex justify-center items-start  h-screen bg-gray-100 mt-16">
        ...
        <div className="max-h-96 mt-3 overflow-auto">
          {unreadNotifications?.length === 0 ? (
            ...
            unreadNotifications?.map((notification) => (
              ...
              >
                <div className="flex items-center border-b cursor-pointer border-gray-200 px-4 py-3 hover:bg-gray-50 transition duration-300 ease-in-out">
                  <div>
                  ...
                  <IoIosClose className="ml-auto w-6 h-6 text-gray-500" />
                </div>
              </div>
            ))
          )}
