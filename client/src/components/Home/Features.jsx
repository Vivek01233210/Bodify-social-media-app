        ...
        <div className="flex flex-wrap -mx-4">
          ...
          <div className="w-full lg:w-1/2 px-4">
            <div className="flex flex-col h-full">
              ...
              <div className="relative pl-4 pb-12 border-l border-dashed border-gray-50 flex-1">
                <div className="absolute top-1 -left-px bg-green-500 w-0.5 h-6" />
          ...
          <div className="w-full lg:w-1/2 px-4">
            <div className="flex flex-col h-full">
              ...
              <div className="relative pl-4 pb-12 border-l border-dashed border-gray-50 flex-1">
                <div className="absolute top-1 -left-px bg-red-600 w-0.5 h-6" />
                <h2 className="text-2xl font-bold font-heading mb-4">
          ...
          <div className="w-full lg:w-1/2 px-4">
            <div className="flex flex-col h-full">
              ...
              <div className="relative pl-4 pb-12 border-l border-dashed border-gray-50 flex-1">
                <div className="absolute top-1 -left-px bg-blue-600 w-0.5 h-6" />
                <h2 className="text-2xl font-bold font-heading mb-4">
                  Intuitive Dashboard
                </h2>
                <p className="text-gray-600">
          ...
          <div className="w-full lg:w-1/2 px-4">
            <div className="flex flex-col h-full">
              ...
              <div className="relative pl-4 pb-12 border-l border-dashed border-gray-50 flex-1">
                <div className="absolute top-1 -left-px bg-pink-500 w-0.5 h-6" />
                <h2 className="text-2xl font-bold font-heading mb-4">
          ...
          <div className="w-full lg:w-1/2 px-4">
            <div className="flex flex-col h-full">
              ...
              <div className="relative pl-4 pb-12 border-l border-dashed border-gray-50 flex-1">
                <div className="absolute top-1 -left-px bg-yellow-500 w-0.5 h-6" />
                <h2 className="text-2xl font-bold font-heading mb-4">
          ...
          <div className="w-full lg:w-1/2 px-4">
            <div className="flex flex-col h-full">
              ...
              <div className="relative pl-4 pb-12 border-l border-dashed border-gray-50 flex-1">
                <div className="absolute top-1 -left-px bg-purple-600 w-0.5 h-6" />
                <h2 className="text-2xl font-bold font-heading mb-4">
                  Engage and Inspire
                </h2>
                <p className="text-gray-600">
