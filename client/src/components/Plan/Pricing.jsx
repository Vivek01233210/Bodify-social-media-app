...
import { getPlansAPI } from "../../APIServices/planAPI";
  ...
  return (
    <section className="py-12 mt-16">
      <div className="container mx-auto px-4">
        ...
        <div className="flex justify-center flex-wrap mb-24 -mx-4">

          {/* Free Plan */}
          <div className="max-w-7xl  p-4">
            <div className="border border-gray-200 rounded-3xl px-8 lg:px-10 pt-10 h-full">
        ...
        <h2 className="text-4xl font-bold font-heading text-center pb-4">
          Pricing FAQs
        </h2>
        <div className="flex flex-wrap -mx-4">
          <div className="w-full lg:w-1/2 px-4">
            <div className="py-4 border-b border-gray-100 h-full">
